 ...
 */
  // функция для правильного склонения слова "день" в календарях
  function endingWordDay(count) {
    let string;
    const n = count % 100;
    switch (true) {
        case n <= 20 && n >= 5:
...
! function (t, e) {
  ...
  var a = function (a, i, s) {
    if (this.parentEl = "body", this.element = e(a), this.startDate = t().startOf("day"), this.endDate = t().endOf("day"), this.minDate = !1, this.maxDate = !1, this.maxSpan = !1, this.autoApply = !1, this.singleDatePicker = !1, this.showDropdowns = !1, this.minYear = t().subtract(100, "year").format("YYYY"), this.maxYear = t().add(100, "year").format("YYYY"), this.showWeekNumbers = !1, this.showISOWeekNumbers = !1, this.showCustomRangeLabel = !0, this.timePicker = !1, this.timePicker24Hour = !1, this.timePickerIncrement = 1, this.timePickerSeconds = !1, this.linkedCalendars = !0, this.autoUpdateInput = !0, this.alwaysShowCalendars = !1, this.ranges = {}, this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = "btn btn-sm", this.applyButtonClasses = "btn-primary", this.cancelButtonClasses = "btn-default", this.locale = {
      ...
      }, this.callback = function () {}, this.isShowing = !1, this.leftCalendar = {}, this.rightCalendar = {}, "object" == typeof i && null !== i || (i = {}), "string" == typeof (i = e.extend(this.element.data(), i)).template || i.template instanceof e || (i.template = '<div class="daterangepicker"><div class="ranges"></div><div class="daterangepicker-wrapper"><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div></div><div class="drp-buttons"><span class="drp-selected"></span><span class="drp-count">(1 день)</span><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'), this.parentEl = i.parentEl && e(i.parentEl).length ? e(i.parentEl) : e(this.parentEl), this.container = e(i.template).appendTo(this.parentEl), "object" == typeof i.locale && ("string" == typeof i.locale.direction && (this.locale.direction = i.locale.direction),
        "string" == typeof i.locale.format && (this.locale.format = i.locale.format),
        "string" == typeof i.locale.formatStart && (this.locale.formatStart = i.locale.formatStart),
        "string" == typeof i.locale.formatEnd && (this.locale.formatEnd = i.locale.formatEnd),
        "string" == typeof i.locale.fromLabel && (this.locale.fromLabel = i.locale.fromLabel),
        "string" == typeof i.locale.beforeFirstDate && (this.locale.beforeFirstDate = i.locale.beforeFirstDate),
        "string" == typeof i.locale.beforeSecondDate && (this.locale.beforeSecondDate = i.locale.beforeSecondDate),
        "string" == typeof i.locale.toLabel && (this.locale.toLabel = i.locale.toLabel),
        "string" == typeof i.locale.separator && (this.locale.separator = i.locale.separator), "object" == typeof i.locale.daysOfWeek && (this.locale.daysOfWeek = i.locale.daysOfWeek.slice()), "object" == typeof i.locale.monthNames && (this.locale.monthNames = i.locale.monthNames.slice()), "object" == typeof i.locale.monthRu && (this.locale.monthRu = i.locale.monthRu.slice()), "number" == typeof i.locale.firstDay && (this.locale.firstDay = i.locale.firstDay), "string" == typeof i.locale.applyLabel && (this.locale.applyLabel = i.locale.applyLabel), "string" == typeof i.locale.cancelLabel && (this.locale.cancelLabel = i.locale.cancelLabel), "string" == typeof i.locale.weekLabel && (this.locale.weekLabel = i.locale.weekLabel), "string" == typeof i.locale.customRangeLabel)) {
  ...
  return a.prototype = {
    ...
    setEndDate: function (e) {
      "string" == typeof e && (this.endDate = t(e, this.locale.format)), "object" == typeof e && (this.endDate = t(e)), this.timePicker || (this.endDate = this.endDate.endOf("day")), this.timePicker && this.timePickerIncrement && this.endDate.minute(Math.round(this.endDate.minute() / this.timePickerIncrement) * this.timePickerIncrement), this.endDate.isBefore(this.startDate) && (this.endDate = this.startDate.clone()), this.maxDate && this.endDate.isAfter(this.maxDate) && (this.endDate = this.maxDate.clone()), this.maxSpan && this.startDate.clone().add(this.maxSpan).isBefore(this.endDate) && (this.endDate = this.startDate.clone().add(this.maxSpan)), this.previousRightTime = this.endDate.clone(), this.container.find(".drp-selected").html(this.locale.fromLabel + ' ' +this.startDate.format(this.locale.format) + this.locale.separator + this.locale.toLabel + ' ' + this.endDate.format(this.locale.format)), this.container.find(".drp-count").html("(" + Math.ceil((this.endDate._d.getTime() - this.startDate._d.getTime()) / (1000 * 3600 * 24)) + ' ' + endingWordDay(Math.ceil((this.endDate._d.getTime() - this.startDate._d.getTime()) / (1000 * 3600 * 24))) + ")"), this.isShowing || this.updateElement(), this.updateMonthsInView()
    },
    ...
    updateView: function () {
      this.timePicker && (this.renderTimePicker("left"), this.renderTimePicker("right"), this.endDate ? this.container.find(".right .calendar-time select").prop("disabled", !1).removeClass("disabled") : this.container.find(".right .calendar-time select").prop("disabled", !0).addClass("disabled")), this.endDate && this.container.find(".drp-selected").html(this.locale.fromLabel + ' ' + this.startDate.format('DD') + ' ' + this.locale.monthRu[this.startDate.format('M') - 1] + this.locale.separator + this.locale.toLabel + ' ' + this.endDate.format('DD') + ' ' + this.locale.monthRu[this.endDate.format('M') - 1]), this.updateMonthsInView(), this.updateCalendars(), this.updateFormInputs()
    },
    ...
    renderCalendar: function (a) {
      ...
      Y += "<thead>", Y += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (Y += "<th></th>"), v && "left" != a ? Y += "<th></th>" : Y += '<th class="prev available"><span></span></th>';
      var w = this.locale.monthNames[i[1][1].month()];
      ...
      if (Y += '<th colspan="5" class="month">' + w + "</th>", C && !C.isAfter(i.lastDay) || this.linkedCalendars && "right" != a && !this.singleDatePicker ? Y += "<th></th>" : Y += '<th class="next available"><span></span></th>', Y += "</tr>", Y += "<tr class='thead-days'>", (this.showWeekNumbers || this.showISOWeekNumbers) && (Y += '<th class="week">' + this.locale.weekLabel + "</th>"), e.each(this.locale.daysOfWeek, function (t, e) {
          Y += "<th>" + e + "</th>"
      ...
      for (b = 0; b < 6; b++) {
        Y += "<tr class='tbody-days'>", this.showWeekNumbers ? Y += '<td class="week">' + i[b][0].week() + "</td>" : this.showISOWeekNumbers && (Y += '<td class="week">' + i[b][0].isoWeek() + "</td>");
        for (k = 0; k < 7; k++) {
          var W = [];
          ...
          R || (j += "available"), Y += '<td class="' + j.replace(/^\s+|\s+$/g, "") + '" data-title="r' + b + "c" + k + '"><span>' + i[b][k].date() + "</span></td>"
        }
        Y += "</tr>"
      }
    ...
    clickDate: function (t) {
      if (e(t.target).closest("td.available")) {
        var a = e(t.target).closest("td.available").attr("data-title"),
          i = a.substr(1, 1),
          s = a.substr(3, 1),
          n = e(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.calendar[i][s] : this.rightCalendar.calendar[i][s];
        if (this.endDate || n.isBefore(this.startDate, "day")) {
          ...
          this.setEndDate(n.clone()), (this.calculateChosenLabel(), this.clickApply())
        }
    ...
    updateElement: function () {
      if (this.element.is("input") && this.autoUpdateInput) {
        ...
        if (!this.singleDatePicker) {
          before = this.locale.beforeFirstDate || 'c ';
          after = this.locale.beforeSecondDate || 'по ';
        } else { before = this.locale.beforeFirstDate || ''}
        var t = before + this.startDate.format(this.locale.format);
        this.singleDatePicker || (t += this.locale.separator + after + this.endDate.format(this.locale.format)), t !== this.element.val() && this.element.val(t).trigger("change")
      }
    },
    remove: function () {
